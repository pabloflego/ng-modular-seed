#AngularJS Modular Seed

Based on John Papa's Modular Demo (https://github.com/johnpapa/ng-demos/tree/master/modular)

## Overview
I've found John Papa's module demo really useful and I wanted to use it as seed for all my future projects, that's why I decided to create this seed app. I've made some changes on the original structure.
